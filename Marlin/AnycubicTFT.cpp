        ...
        switch(a_command){
          ...
          case 23: // A23 preheat pla
            if((!planner.movesplanned())&& (TFTstate!=ANYCUBIC_TFT_STATE_SDPAUSE) && (TFTstate!=ANYCUBIC_TFT_STATE_SDOUTAGE))
            {
              ...
              thermalManager.setTargetBed(55);          //DIY3D 20181116 changed default temperatur for preheat ABS from 50 to 55
              thermalManager.setTargetHotend(195, 0);   //DIY3D 20181114 changed default temperatur for preheat ABS from 200 to 195
              ANYCUBIC_SERIAL_SUCC_START;
              ANYCUBIC_SERIAL_ENTER();
            }
            break;
          case 24:// A24 preheat abs
            ...
            {
              if((current_position[Z_AXIS]<10)) enqueue_and_echo_commands_P(PSTR("G1 Z10")); //RAISE Z AXIS
              thermalManager.setTargetBed(105);         //DIY3D 20181114 changed default temperatur for preheat ABS from 80 to 105
              thermalManager.setTargetHotend(230, 0);   //DIY3D 20181114 changed default temperatur for preheat ABS from 240 to 230
