...
#define STRING_CONFIG_H_AUTHOR "(DIY3D, Anycubic i3 Mega)" // Who made the changes.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5       //DIY3D 20181116: Set grid points from default value = 3 to 5
